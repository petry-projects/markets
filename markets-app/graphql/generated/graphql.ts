...
export type MyNotificationPrefsQuery = { __typename?: 'Query', myNotificationPreferences?: { __typename?: 'NotificationPreferences', id: string, userID: string, pushEnabled: boolean, vendorCheckInAlerts: boolean, marketUpdateAlerts: boolean, exceptionAlerts: boolean, createdAt: string, updatedAt: string } | null };
